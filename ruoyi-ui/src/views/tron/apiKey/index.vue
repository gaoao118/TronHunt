<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="可用次数" prop="usable">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['apiKey:apiKey:remove']"
        >删除
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['apiKey:apiKey:export']"
        >导出
        </el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="apiKeyList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="请求密钥" align="center" prop="apiKey"/>
      ...
      <el-table-column label="可用次数" align="center" prop="usable"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="请求密钥" prop="apiKey">
          <el-input v-model="form.apiKey" placeholder="请输入请求密钥"/>
        </el-form-item>
        <el-form-item label="私钥" prop="privateKey">
          <el-input v-model="form.privateKey" placeholder="请输入私钥"/>
        </el-form-item>
        <el-form-item label="可用次数" prop="usable">
          <el-input v-model="form.usable" placeholder="请输入可用次数"/>
        </el-form-item>
        <el-form-item label="备注" prop="remark">
...
<script>
import {addApiKey, delApiKey, getApiKey, listApiKey, updateApiKey} from "@/api/apiKey/apiKey";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        apiKey: [
          {required: true, message: "请求密钥不能为空", trigger: "blur"}
        ],
        usable: [
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除请求key编号为"' + ids + '"的数据项？').then(function () {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('apiKey/apiKey/export', {
        ...this.queryParams
